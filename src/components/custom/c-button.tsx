...
const CButton: React.FC<CButtonProps> = ({ children, loading = false, styleType = 'default', className, ...rest }) => {
    ...
    return (
        <Button className={cn(baseClass, typeClass, className)} {...rest}>
            {
                loading ? (<div><svg aria-hidden="true" className="!w-6 !h-6 text-gray-200 animate-spin dark:text-gray-600 fill-c-secondary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
